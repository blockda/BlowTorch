...
public class SettingsGroup extends Option implements Parcelable {
	...
	public SettingsGroup(Parcel p) {
		...
		for(int i=0;i<size;i++) {
			...
			switch(type) {
			case OPTION_BOOLEAN:
				o = p.readParcelable(com.offsetnull.bt.service.plugin.settings.BooleanOption.class.getClassLoader());
				break;
			case OPTION_LIST:
				o = p.readParcelable(com.offsetnull.bt.service.plugin.settings.ListOption.class.getClassLoader());
				
				break;
			case OPTION_OPTIONS:
				o = p.readParcelable(com.offsetnull.bt.service.plugin.settings.SettingsGroup.class.getClassLoader());
				
				break;
			case OPTION_ENCODING:
				o = p.readParcelable(com.offsetnull.bt.service.plugin.settings.EncodingOption.class.getClassLoader());
				break;
			case OPTION_INTEGER:
				o = p.readParcelable(com.offsetnull.bt.service.plugin.settings.IntegerOption.class.getClassLoader());
				break;
			case OPTION_COLOR:
				o = p.readParcelable(com.offsetnull.bt.service.plugin.settings.ColorOption.class.getClassLoader());
				break;
			case OPTION_FILE:
			...
			case OPTION_CALLBACK:
				o = p.readParcelable(com.offsetnull.bt.service.plugin.settings.CallbackOption.class.getClassLoader());
				break;
			}
