...
public class BaardTERMService extends Service {
	...
	final RemoteCallbackList<IBaardTERMServiceCallback> callbacks = new RemoteCallbackList<IBaardTERMServiceCallback>();
	...
	public void sendBuffer() throws RemoteException {
		...
		for(int i = 0;i<N;i++) {
			...
			callbacks.getBroadcastItem(i).rawDataIncoming(the_buffer.toString());
		}
