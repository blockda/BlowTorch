		...
		for(int i=0;i<data.length;i++) {
			...
			case IAC:
				...
				//} else if(data[i+1] == IP)  {
					...
					case GOAHEAD:
					case IP:
						//TODO: REAL IP HANDLING HERE, I THINK THIS INVOLVES SETTING THE CURSOR BACK TO A PLACE OR SOMETHING
					case BREAK:
					case AO:
						//i think this one is more for us to send to the server.
					case EC:
